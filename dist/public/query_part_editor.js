  ...
  return {
    ...
    execute: function () {
      define(['angular', 'lodash', 'jquery'], function (angular, _, $) {
        ...
        angular.module('grafana.directives').directive('sqlQueryPartEditor', function ($compile, templateSrv) {
          ...
          return {
            ...
            link: function postLink($scope, elem) {
              ...
              function addTypeahead($input, param, paramIndex) {
                ...
                var typeaheadSource = function typeaheadSource(query, callback) {
                  if (param.options) {
