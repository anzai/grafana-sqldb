                        ...
                        SqlDatasource = function () {
                            ...
                            SqlDatasource.prototype.annotationQuery = function (options) {
                                ...
                                if (!options.annotation.query || options.annotation.query === '') {
                                    ...
                                    castTimeCol += ' * 1000';
                                    options.annotation.query = 'SELECT ' + castTimeCol + ' AS "time", ' + (options.annotation.tags || 'NULL') + ' AS "tags", ' + (options.annotation.title || 'NULL') + ' AS "title", ' + (options.annotation.text || 'NULL') + ' AS "text" ' + 'FROM ' + options.annotation.schema + '.' + options.annotation.table + ' ' + 'WHERE $timeFilter';
                                }
                            ...
                            SqlDatasource.prototype.metricFindQuery = function (query) {
                                ...
                                return this._seriesQuery(interpolated).then(lodash_1.default.curry(this.responseParser.parse)(query));
                            };
                            ;
