                    ...
                    execute: function execute() {
                        SqlQueryCtrl = function (_super) {
                            ...
                            SqlQueryCtrl.prototype.getSchemaSegments = function () {
                                ...
                                return this.datasource.metricFindQuery(schemasQuery).then(this.transformToSegments(false)).catch(this.handleQueryError.bind(this));
                            };
                            ...
                            SqlQueryCtrl.prototype.getTimeColDataTypeSegments = function () {
                                ...
                                return this.datasource.metricFindQuery(timeColQuery).then(this.transformToSegments(false)).catch(this.handleQueryError.bind(this));
                            };
                            ...
                            SqlQueryCtrl.prototype.getTagsOrValues = function (segment, index) {
                                ...
                                if (segment.type === 'operator') {
                                    ...
                                    if (/^\/.*\/$/.test(nextValue)) {
                                        return this.$q.when(this.uiSegmentSrv.newOperators([this.matchOperators.match, this.matchOperators.not]));
                                    } else {
                            ...
                            SqlQueryCtrl.prototype.getTagValueOperator = function (tagValue, tagOperator) {
                                if (tagOperator !== this.matchOperators.match && tagOperator !== this.matchOperators.not && /^\/.*\/$/.test(tagValue)) {
                                    return this.matchOperators.match;
                                } else if ((tagOperator === this.matchOperators.match || tagOperator === this.matchOperators.not) && /^(?!\/.*\/$)/.test(tagValue)) {
                                    return '=';
                                }
                            };
